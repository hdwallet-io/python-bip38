...
.. |Build Status| image:: https://img.shields.io/github/actions/workflow/status/hdwallet-io/python-bip38/build.yml
   :target: https://github.com/hdwallet-io/python-bip38/actions/workflows/build.yml
...
.. |Coverage Status| image:: https://coveralls.io/repos/github/hdwallet-io/python-bip38/badge.svg?branch=master
   :target: https://coveralls.io/github/hdwallet-io/python-bip38?branch=master
...
For more information, see the `CONTRIBUTING.md <https://github.com/hdwallet-io/python-bip38/blob/master/CONTRIBUTING.md>`_ file.
